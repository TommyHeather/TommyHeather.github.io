// ===============================
// Safe init (so JS failure won't hide system cursor)
// ===============================
...
window.addEventListener("mousemove", (e) => {
  ...
  // Important: we set left/top to not break CSS translate(-50%,-50%)
  if (dot) {
...
// ===============================
// Smooth scroll (nav + floating button)
// ===============================
...
const translations = {
  ru: {
    text: {
      ...
      hero_subtitle:
        "Делаю сервера, ботов и автоматизации, которые не падают ночью и экономят кучу времени.",
      hero_chip1: "Minecraft-инфраструктура",
      hero_chip2: "Telegram / Discord боты",
      hero_chip3: "Автоматизация процессов",
      hero_bio:
        "Работаю с Linux-серверами, Minecraft-сетями, ботами и железом. Люблю, когда всё собрано аккуратно, прозрачно и без магии: понятные конфиги, мониторинг и резервные копии.",

      games_title: "Игры",
      games_subtitle: "Minecraft-экосистема от сервера до ботов.",
      mc_title: "Minecraft",
      mc_intro:
        "Полный цикл работы с Minecraft-проектами: от чистого сервера до продвинутых сборок и интеграций.",

      social_title: "Соц-сети",
      social_subtitle: "Боты, автоматизация и удобные сценарии общения.",
      tg_title: "Telegram",
      tg_text:
        "Боты на любой вкус и цвет: автоматизация, модерация, игры, системы регистрации и многое другое.",
      tg_link: "Написать в Telegram",

      ds_title: "Discord",
      ds_text:
        "Игровые боты и инструменты, которые упрощают жизнь админам: автомодерация, модерация, сервисные роли.",
      ds_link: "Discord-сервер",

      waig_title: "WhatsApp & Instagram",
      waig_text:
        "Автоматизация действий, страничные и бизнес-боты, интегрированные веб-сайты и приложения.",
      waig_link: "Связаться через WhatsApp / Instagram",

      vk_title: "ВКонтакте",
      vk_text:
        "Страничные и публичные боты, автоматизация действий, мини-игры, модерация и интеграции с другими системами.",
      vk_link: "Страница ВК",
      ...
      linux_text:
        "Продуманная конфигурация игровых и сервисных серверов на Ubuntu / Debian.",

      auto_title: "Автоматизация",
      auto_text:
        "Скрипты и сервисы, которые снимают рутину как на Windows, так и на Linux.",
      ...
      contact_socials_text:
        "Проще всего написать в Telegram или Discord — отвечаю там чаще всего.",
      contact_tg: "Telegram",
      contact_ds: "Discord",
      contact_vk: "VK",
      contact_wa: "WhatsApp",
  ...
  en: {
    text: {
      ...
      hero_subtitle:
        "I build servers, bots and automations that stay online at night and save a lot of time.",
      hero_chip1: "Minecraft infrastructure",
      hero_chip2: "Telegram / Discord bots",
      hero_chip3: "Process automation",
      hero_bio:
        "I work with Linux servers, Minecraft networks, bots and hardware. I like when everything is clean and transparent: clear configs, monitoring and backups.",

      games_title: "Games",
      games_subtitle: "Minecraft ecosystem from server to bots.",
      mc_title: "Minecraft",
      mc_intro:
        "Full cycle of Minecraft projects: from a clean server to advanced modpacks and integrations.",

      social_title: "Social",
      social_subtitle: "Bots, automation and smooth communication flows.",
      tg_title: "Telegram",
      tg_text:
        "Bots for any taste: automation, moderation, games, registration flows and much more.",
      tg_link: "Message on Telegram",

      ds_title: "Discord",
      ds_text:
        "Game bots and tools that make admins’ life easier: automoderation, moderation and service roles.",
      ds_link: "Discord server",

      waig_title: "WhatsApp & Instagram",
      waig_text:
        "Automation, page/business bots and integrated websites or mini-apps.",
      waig_link: "Contact via WhatsApp / Instagram",

      vk_title: "VK",
      vk_text:
        "Page and group bots, automation, mini-games, moderation and integrations with other systems.",
      vk_link: "VK page",
      ...
      linux_text:
        "Thought-out configuration of game and service servers on Ubuntu / Debian.",

      auto_title: "Automation",
      auto_text:
        "Scripts and services that remove routine on both Windows and Linux.",
      ...
      contact_socials_text:
        "The fastest way is Telegram or Discord — I respond there most often.",
      contact_tg: "Telegram",
      contact_ds: "Discord",
      contact_vk: "VK",
      contact_wa: "WhatsApp",
      ...
      footer_text:
        "© 2025 Tushkanchik. Feel free to share, but better ask first.",
  ...
  he: {
    text: {
      ...
      hero_subtitle:
        "מקימה שרתים, בוטים ואוטומציות שעובדים בלילה וחוסכים המון זמן.",
      hero_chip1: "תשתית Minecraft",
      hero_chip2: "בוטים ל-Telegram / Discord",
      hero_chip3: "אוטומציה של תהליכים",
      hero_bio:
        "עובד עם שרתי Linux, רשתות Minecraft, בוטים וחומרה. אוהב שדברים מסודרים ונקיים: קונפיגים ברורים, ניטור וגיבויים.",

      games_title: "משחקים",
      games_subtitle: "אקוסיסטמת Minecraft – מהשרת עד לבוטים.",
      mc_title: "Minecraft",
      mc_intro:
        "מחזור מלא של פרויקטי Minecraft: משרת נקי עד חבילות מתקדמות ואינטגרציות.",

      social_title: "רשתות חברתיות",
      social_subtitle: "בוטים, אוטומציה וזרימה נוחה של שיחות.",
      tg_title: "Telegram",
      tg_text:
        "בוטים בכל סגנון: אוטומציה, מודרציה, משחקים, רישום משתמשים ועוד.",
      tg_link: "לכתוב ב-Telegram",

      ds_title: "Discord",
      ds_text:
        "בוטים למשחקים וכלים שמקלים על אדמינים: אוטומודרציה, מודרציה ותפקידים שירותיים.",
      ds_link: "שרת Discord",

      waig_title: "WhatsApp & Instagram",
      waig_text:
        "אוטומציה, בוטים עסקיים / דפי אינסטה, אתרים ואפליקציות משולבים.",
      waig_link: "יצירת קשר דרך WhatsApp / Instagram",

      vk_title: "VK",
      vk_text:
        "בוטים לעמודים ולקבוצות, אוטומציה, משחקונים, מודרציה ואינטגרציות.",
      vk_link: "עמוד VK",
      ...
      auto_title: "אוטומציה",
      auto_text:
        "סקריפטים ושירותים שמורידים את השגרה גם ב-Windows וגם ב-Linux.",
      ...
      contact_socials_text:
        "הכי נוח לכתוב ב-Telegram או ב-Discord – שם אני עונה הכי הרבה.",
      contact_tg: "Telegram",
      contact_ds: "Discord",
      contact_vk: "VK",
      contact_wa: "WhatsApp",
...
if (contactForm) {
  contactForm.addEventListener("submit", (e) => {
    e.preventDefault();
    alert(
      "Форма пока не отправляет письмо. Настройте backend или сервис форм и замените обработчик в script.js."
    );
  });
}
